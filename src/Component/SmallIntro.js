...
export default function SmallIntro() {
  return (
    <div className='containerWrap1 p-4 flex justify-center '>
        <div className=' mx-4 text-center w-[90%] flex flex-col items-center'>
               <motion.h1 
               initial={{opacity:0,y:40}}
               whileInView={{opacity:1,y:0}}
               transition={{duration:0.5,delay:0.5}}
               className='font-bold text-4xl text-[#7F00FF] my-2 w-[70%]'>Welcome to Dr. Firoj Functional Organic Materials Research Group website.</motion.h1>
